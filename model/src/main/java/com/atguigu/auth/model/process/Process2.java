package com.atguigu.auth.model.process;

import com.atguigu.auth.model.base.BaseEntity;
...
@Data
@ApiModel(description = "Process2")
@TableName("oa_process")
public class Process2 extends BaseEntity {
