...
public class DatabaseTest {
    ...
    public static ProcessConfig getProcessConfig() {
        ...
        // 忽略表前缀，如忽略a开头的数据库表
        List< String > ignorePrefix = Arrays.asList("oa_");
        // 忽略表后缀
        List< String > ignoreSuffix = Arrays.asList("_test","act_");
        // 需要生成数据库文档的表
        List< String > designatedTableName = Arrays.asList("oa_process", "oa_process_type");
        // 需要生成数据库文档的表前缀
        List< String > designatedTablePrefix = Arrays.asList(" ", " ");
        // 需要生成数据库文档的表后缀
